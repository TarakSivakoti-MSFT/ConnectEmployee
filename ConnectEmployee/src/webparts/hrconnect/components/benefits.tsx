      ...
      <div>
        ...
        <div className={cx("card", style.card)}>
          <div className="card-body">
            ...
            <ul className="list-group">
              <a className={style.benefitlink} href="https://contosohealthsystem.sharepoint.com/:b:/s/ConnectEmployee/EQMAZ0gt_DVLrilaggy1khkBqJmHbLO4bWnb0ey3mf7WVQ?e=RPDpwk" target="_blank">
                <li  className="list-group-item">
                Medical Insurance <span className="float-right"><i className="fa fa-check text-primary"></i></span> 
                </li>
                </a>
                <a className={style.benefitlink} href="https://contosohealthsystem.sharepoint.com/:b:/s/ConnectEmployee/EdlvadQVO8hPspA_8cyu3boBNKwZBQupSs8Cts-X69eJ8g?e=q6KZj8" target="_blank">
                <li  className="list-group-item">
                  Retirement Benefits <span className="float-right"><i className="fa fa-check text-primary"></i></span> 
                </li>
                </a>
                <a className={style.benefitlink} href="https://contosohealthsystem.sharepoint.com/:b:/s/ConnectEmployee/EY6_avLKF1VIseWHcjHLzO4BD_BayVeSrr7NKVELR26SFA?e=HX7zyD" target="_blank">
                <li  className="list-group-item">
        ...
        <div className={cx("card", style.card)}>
          <div className="card-body">
            ...
            <ul className="list-group">
                <li className="list-group-item" onClick={() => this._showModal("Life Insurance")}>
                Life Insurance <span className="float-right"><i className="fa fa-close text-danger"></i></span> 
                </li>
                <li className="list-group-item" onClick={() => this._showModal(" Disability Insurance ")}>
                Disability Insurance <span className="float-right"><i className="fa fa-close text-danger"></i></span> 
                </li>
                <li className="list-group-item" onClick={() => this._showModal("Vacation")}>
